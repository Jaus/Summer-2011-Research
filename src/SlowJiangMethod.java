...
public class SlowJiangMethod extends WikipediaExtender {

	public static void main(String[] args) throws Exception {
		new SlowJiangMethod("/usr/local/WordNet-3.0/dict", args[0]).run();
	}
	
	public SlowJiangMethod(String wordnetPath, String wikiPath) {
		super(wordnetPath, wikiPath);
	}
	
	public SlowJiangMethod(String wordnetpath, String wikipediapath, edu.mit.jwi.Dictionary d, LexicalizedParser p, GrammaticalStructureFactory g) {
